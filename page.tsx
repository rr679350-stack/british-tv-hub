export default function BritishTVHub() {
  ...
  return (
    <div className="min-h-screen bg-[#120706] text-[#f5ead7]">
      ...
      <section className="relative min-h-screen overflow-hidden border-b border-[#5e3417] bg-[#120706]">
        ...
        <header className="relative z-10 border-b border-[#5e3417] bg-[#2a120a]/95 backdrop-blur shadow-[0_2px_20px_-2px_rgba(184,150,62,0.3),0_1px_0_0_rgba(184,150,62,0.15)]">
          <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
            <div className="flex items-center gap-3 text-xl font-semibold tracking-tight text-[#f7e8d2]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-sm border border-[#b11f4b] bg-[#b11f4b] px-5 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white transition hover:bg-[#c42355]"
            >
              Follow on Facebook
            </a>
          </div>
        ...
        <div id="home" className="relative z-10 mx-auto flex max-w-7xl items-center px-6 py-20 lg:min-h-[calc(100vh-88px)] lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-8 flex items-center justify-center gap-4 text-sm uppercase tracking-[0.35em] text-[#c99f4e]">
              <span className="h-px w-16 bg-[#8b6322]" />
              <span>Est. for British TV fans</span>
              <span className="h-px w-16 bg-[#8b6322]" />
            </div>

            <h1 className="font-serif text-5xl leading-none text-[#f7ead7] sm:text-6xl lg:text-8xl">
              Your Cozy Guide to the Best British TV
            </h1>

            <div className="mt-5 font-serif text-3xl italic text-[#d9a63d] sm:text-4xl">
              Classics & New Favorites
            </div>

            <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-[#eadbc8] sm:text-2xl">
              Discover the best British mysteries, hidden gems, and fan favorites.
            </p>

            <p className="mx-auto mt-6 max-w-3xl text-lg italic leading-8 text-[#c99f4e] sm:text-xl">
              Join 4,000+ fans sharing daily recommendations, debates, and hidden gems.
            </p>

            <div className="mt-8 text-sm uppercase tracking-[0.22em] text-[#d9a63d]">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="min-w-[320px] rounded-sm border border-[#b11f4b] bg-[#b11f4b] px-8 py-4 text-center text-sm font-semibold uppercase tracking-[0.25em] text-white transition hover:bg-[#c42355]"
              >
                Follow Us on Facebook
              </a>
              <a
                href="#top-shows"
                className="min-w-[320px] rounded-sm border-2 border-[#d9a63d] bg-transparent px-8 py-4 text-center text-sm font-semibold uppercase tracking-[0.25em] text-[#d9a63d] transition hover:bg-[#d9a63d]/10 hover:text-white"
              >
                Browse Top Shows
              </a>
            </div>

            <div className="mt-16 grid gap-8 border-t border-[#5e3417] pt-10 sm:grid-cols-3">
              <div>
                <div className="font-serif text-5xl text-[#d9a63d]">4K+</div>
                <div className="mt-2 text-sm uppercase tracking-[0.25em] text-[#d7c5af]">Followers</div>
              </div>
              <div>
                <div className="font-serif text-5xl text-[#d9a63d]">100+</div>
                <div className="mt-2 text-sm uppercase tracking-[0.25em] text-[#d7c5af]">Series Covered</div>
              </div>
              <div>
                <div className="font-serif text-5xl text-[#d9a63d]">Daily</div>
                <div className="mt-2 text-sm uppercase tracking-[0.25em] text-[#d7c5af]">New Content</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-t border-[#3a1a1a] bg-[#1a0a0a] py-16 px-6">
        <div className="mx-auto max-w-3xl">
          ...
          <h2 className="font-serif text-5xl font-normal text-[#f0e6d3]">
            Trending Radar
          </h2>
          ...
          <p className="text-2xl text-[#c8b89a]">
          ...
          <div className="mt-8">
            {trendingShows.map((show, i) => (
              <div key={i}>
                <div className="flex items-start gap-4 py-4 transition-colors duration-200 hover:bg-[#251212] -mx-4 px-4 rounded">
                  <span className="w-6 text-left font-sans text-sm text-[#b8963e] pt-1">{i + 1}</span>
                  <span className="text-base pt-1">{show.emoji}</span>
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="font-serif text-2xl text-[#f0e6d3]">{show.title}</span>
                    ...
                    <p className="mt-2 font-sans text-xl text-[#c8b89a] leading-relaxed">{show.desc}</p>
                  </div>
                </div>
      ...
      <section id="about" className="border-b border-[#5e3417] bg-[#2a120a]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">Why We Love British TV</h2>
          ...
          <div className="mt-16 grid gap-12 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="space-y-6 text-xl leading-[1.9] text-[#f0dfcb]">
              <p>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={card.title} className="rounded-sm border border-[#b8963e]/40 bg-[#3a1a10] p-8 shadow-lg">
                  <div className="flex gap-5">
                    <div className="flex h-16 w-16 shrink-0 items-center justify-center border border-[#d9a63d] bg-[#2a120a] text-3xl text-[#d9a63d]">
                      {card.icon}
                    </div>
                    <div>
                      <h3 className="font-serif text-3xl text-[#f7ead7]">{card.title}</h3>
                      <p className="mt-3 text-xl leading-8 text-[#e4cfb7]">{card.text}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <section id="top-shows" className="border-b border-[#5e3417] bg-[#120706]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">{"The 5 British Mysteries Everyone's Talking About This Week"}</h2>
            <div className="mt-6 flex items-center justify-center gap-5 text-[#c99f4e]">
              <span className="h-px w-24 bg-[#8b6322]" />
              <span className="text-xl">✦</span>
              <span className="h-px w-24 bg-[#8b6322]" />
            </div>
            <p className="mx-auto mt-8 max-w-4xl text-2xl leading-9 text-[#e8d5bf]">
              The British dramas and mysteries our community is watching, debating, and recommending right now.
            </p>
            <p className="mx-auto mt-5 max-w-3xl text-lg uppercase tracking-[0.18em] text-[#d9a63d]">
      ...
      <section className="border-b border-[#5e3417] bg-[#2a120a]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">Hidden Gems You Missed</h2>
            <div className="mt-6 flex items-center justify-center gap-5 text-[#c99f4e]">
              <span className="h-px w-24 bg-[#8b6322]" />
              <span className="text-xl">✧</span>
              <span className="h-px w-24 bg-[#8b6322]" />
          ...
          <div className="mx-auto mt-14 grid max-w-5xl gap-6 md:grid-cols-3">
            {["McDonald & Dodds", "Annika", "Blue Lights"].map((show) => (
              <div key={show} className="rounded-sm border border-[#5e3417] bg-[#3a1a10] p-6 shadow-lg">
                <h3 className="font-serif text-3xl text-[#f7ead7]">{show}</h3>
                <p className="mt-4 text-lg leading-8 text-[#e4cfb7]">
      ...
      <section className="border-b border-[#5e3417] bg-[#0f0504]">
        <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">Best Cozy Shows for the Weekend</h2>
            <div className="mt-6 flex items-center justify-center gap-5 text-[#c99f4e]">
              <span className="h-px w-24 bg-[#8b6322]" />
              <span className="text-xl">❋</span>
              <span className="h-px w-24 bg-[#8b6322]" />
          ...
          <div className="mt-14 overflow-x-auto pb-4 -mx-6 px-6 scrollbar-thin scrollbar-track-[#1a0a0a] scrollbar-thumb-[#5e3417]">
            <div className="flex gap-0 min-w-max">
              {[
                ...
                <div 
                  key={show.title} 
                  className={`flex min-w-[400px] border-l-4 border-[#d9a63d] transition-all duration-200 hover:brightness-125 ${
                    index % 2 === 0 ? 'bg-[#1a0a08]' : 'bg-[#241210]'
                  }`}
                >
                  {/* Large number */}
                  <div className="flex w-28 shrink-0 items-center justify-center border-r border-[#3a1a10]">
                    <span className="font-serif text-6xl font-bold text-[#d9a63d]/80">{show.num}</span>
                  </div>
                  
                  {/* Content */}
                  <div className="flex-1 p-8">
                    <h3 className="font-serif text-3xl font-bold text-[#f7ead7]">{show.title}</h3>
                    ...
                    <p className="mt-4 font-serif text-lg italic text-[#d9a63d]">
                      {`"${show.whyPicked}"`}
                    </p>
      ...
      <section className="border-b border-[#5e3417] bg-[#2a120a]">
        <div className="mx-auto max-w-5xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">What Should You Watch Next?</h2>
            <div className="mt-6 flex items-center justify-center gap-5 text-[#c99f4e]">
              <span className="h-px w-24 bg-[#8b6322]" />
              <span className="text-xl">★</span>
              <span className="h-px w-24 bg-[#8b6322]" />
            </div>
            <p className="mx-auto mt-8 max-w-3xl text-2xl leading-9 text-[#e8d5bf]">
      ...
      <section id="contact" className="bg-[#120706]">
        <div className="mx-auto max-w-5xl px-6 py-20 lg:px-10">
          <div className="text-center">
            <h2 className="font-serif text-4xl text-[#f7ead7] sm:text-6xl">{"Let's Talk Telly"}</h2>
            <div className="mt-6 flex items-center justify-center gap-5 text-[#c99f4e]">
              <span className="h-px w-24 bg-[#8b6322]" />
              <span className="text-xl">◦</span>
              <span className="h-px w-24 bg-[#8b6322]" />
          ...
          <div className="mx-auto mt-14 max-w-3xl space-y-6">
            <div className="rounded-sm border border-[#5e3417] bg-[#2a120a] p-8 shadow-lg">
              <div className="flex gap-5">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center border border-[#8b6322] bg-[#5a1624] text-2xl text-[#d9a63d]">
                  f
                </div>
                <div>
                  <h3 className="font-serif text-3xl text-[#f7ead7]">Facebook Community</h3>
                  <p className="mt-3 text-xl leading-8 text-[#e4cfb7]">
            ...
            <div className="rounded-sm border border-[#7a2434] bg-[#5a1624] p-10 text-center shadow-xl">
              <p className="mx-auto max-w-3xl text-2xl italic leading-9 text-[#f3dfcb]">
